...
with tabs[0]:
    ...
    current_rate = st.number_input(label = "Current conversion rate", value = 0.10, min_value = 0.0, max_value = 1.0)
    ...
    desired_rate = st.number_input(label = "Desired conversion rate", value = 0.15, min_value = 0.0, max_value = 1.0)
